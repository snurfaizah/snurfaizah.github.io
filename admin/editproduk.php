                    ...
                    <div class="card shadow mb-4">
                        <center>
                            <div class="card-header py-3">
                                <h2 class="m-0 font-weight-bold text-primary">Edit Produk</h2>
                                <br>
                                <a class="btn btn-primary" href="tampilproduk.php" role="button">Batal</a>
                            </div>    
                        </center>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="prosesupdate.php">
                                <div class="row mb-3">
                                    <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['id_produk']; ?>">
                                </div>
                                <div class="row mb-3">
